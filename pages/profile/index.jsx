        ...
        <div className="modal-box">
          ...
          <section className="w-full">
            ...
            <label
              ...
              className={
                loading ? "btn btn-sm btn-secondary w-full text-white shadow-lg font-Roboto mt-2 btn-square loading rounded-[20px] md:h-10" : "btn btn-sm btn-secondary w-full text-white shadow-lg font-Roboto mt-2 rounded-[20px] md:h-10"
              }
            >
              {loading ? "" : "Cancel"}
            </label>
