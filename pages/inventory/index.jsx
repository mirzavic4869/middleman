...
function Inventory() {
	...
	const editData = async (e, idProduct) => {
		...
		fetch(
			`https://virtserver.swaggerhub.com/vaniliacahya/capstone/1.0.0/users/products/${idProduct}`,
			requestOptions
		)
			.then((response) => response.json())
			.then((result) => {
	...
	const searchData = async (e, productName) => {
		...
		fetch(
			`https://virtserver.swaggerhub.com/vaniliacahya/capstone/1.0.0/users/products/search?productname=${productName}`,
			requestOptions
		)
			.then((response) => response.json())
			.then((result) => {
